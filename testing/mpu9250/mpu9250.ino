 ...
 * MPU9250_WE mpu9250 = MPU9250_WE()              -> uses Wire / I2C Address = 0x68
 * MPU9250_WE mpu9250 = MPU9250_WE(MPU9250_ADDR)  -> uses Wire / MPU9250_ADDR
 * MPU9250_WE mpu9250 = MPU9250_WE(&wire2)        -> uses the TwoWire object wire2 / MPU9250_ADDR
 * MPU9250_WE mpu9250 = MPU9250_WE(&wire2, MPU9250_ADDR) -> all together
...
void setup() {
   ...
   */
  //mpu9250.setGyrOffsets(45.0, 145.0, -105.0);
  ...
  //mpu9250.disableGyrDLPF(MPU9250_BW_WO_DLPF_8800); // bandwdith without DLPF
   ...
   */
  mpu9250.setAccRange(MPU9250_ACC_RANGE_16G);
